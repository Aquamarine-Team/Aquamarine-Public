...
namespace pocketmine {
	...
	const VERSION = "1.0.4-public release";
	const API_VERSION = "3.0.1";
	const CODENAME = "vk.com/aquamarine.team";
	...
	if(!flock(\pocketmine\LOCK_FILE, LOCK_EX | LOCK_NB)){
		...
		echo "[CRITICAL] Another Aquamarine instance (PID $pid) is already using this folder (" . realpath(\pocketmine\DATA) . ")." . PHP_EOL;
